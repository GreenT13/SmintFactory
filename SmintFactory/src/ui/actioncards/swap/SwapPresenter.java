...
public class SwapPresenter implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		model.getIsSwapButtonUsed().addListener(new ChangeListener<Boolean>(){
			@Override
			public void changed(ObservableValue<? extends Boolean> arg0, Boolean arg1, Boolean arg2) {
				swapButton1.setDisable(model.getIsSwapButtonUsed().getValue());
			}
		});
	...
	private void actionSwap(ActionEvent event){
		model.doAction(Action.SWAP, false);
    }
