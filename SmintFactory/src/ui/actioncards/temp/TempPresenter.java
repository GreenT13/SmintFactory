...
public class TempPresenter implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		model.getIsTempButtonUsed().addListener(new ChangeListener<Boolean>(){
			@Override
			public void changed(ObservableValue<? extends Boolean> arg0, Boolean arg1, Boolean arg2) {
				tempButton1.setDisable(model.getIsTempButtonUsed().getValue());
			}
		});
	...
	private void actionTemp(ActionEvent event){
		model.doAction(Action.TEMP, false);
    }
}
